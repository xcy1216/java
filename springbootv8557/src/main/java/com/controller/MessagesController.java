...
//    @RequestMapping("messages/list")
    public R listZ(@RequestParam Map<String, Object> params,MessagesEntity messages,
...
//    @RequestMapping("messages/add")
    public R addZ(@RequestBody MessagesEntity messages, HttpServletRequest request){
        ...
        if(!request.getSession().getAttribute("role").toString().equals("管理员")) {
            ...
            String username = usersService.selectById((Long) request.getSession().getAttribute("userId")).getUsername();
            messages.setUsername(username);
            System.out.println("不是管理员");
        }
        messagesService.insert(messages);
        System.out.println("展示保存的信息"+messages.getImage());
        return R.ok();
    }
...
//     * 后台查询
//     */
////    @RequestMapping("messages/query")
//    @RequestMapping("admin/message/query")
...
//        messagesService.insert(messages);
//
//        System.out.println("展示保存的信息"+messages);
//
//        return R.ok();
//    }
...
//    @RequestMapping("messages/update")
    @RequestMapping("/admin/message/update")
    @Transactional
...
//    @RequestMapping("messages/delete")
     ...
     * 后台详情
     */
    @RequestMapping("/admin/message/info/{id}")
//    @RequestMapping("messages/info/{id}")
