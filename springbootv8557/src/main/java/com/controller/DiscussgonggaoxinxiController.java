...
public class DiscussgonggaoxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussgonggaoxinxiEntity discussgonggaoxinxi,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussgonggaoxinxiEntity discussgonggaoxinxi, 
		HttpServletRequest request){
        EntityWrapper<DiscussgonggaoxinxiEntity> ew = new EntityWrapper<DiscussgonggaoxinxiEntity>();
