	...
	<div class="main-containers">
		<div>
			<div class="top-container"
				:style='{ "margin": "0 auto", "overflow": "hidden", "alignItems": "center", "background": "none", "display": "flex", "width": "1200px", "position": "relative", "justifyContent": "space-between", "height": "100px", "zIndex": "1002" }'>
				<img v-if='false'
				...
				<div v-if="true" :style='{ "color": "rgba(82, 181, 72, 1)", "margin": "0", "fontSize": "30px" }'>智果易联
				</div>
				<div>
					<div v-if="false"
						:style='{ "fontSize": "14px", "color": "#666", "background": "red", "display": "inline-block" }'>
					</div>
					<div v-if="Token"
						:style='{ "fontSize": "14px", "color": "#666", "background": "red", "display": "inline-block" }'>
						{{
					...
					<el-button v-if="!Token" @click="toLogin()"
						:style='{ "border": "none", "padding": "0 20px", "margin": "0 20px", "color": "#f4f4f5", "borderRadius": "20px", "background": "#4fa946", "display": "inline-block", "fontSize": "18px", "lineHeight": "36px", "height": "36px" }'>登录/注册</el-button>
		...
		<div class="menu-preview"
			:style='{ "width": "100%", "background": "none", "backgroundImage": "url(http://localhost:8082/img/background.00d500ab.jpg)", "height": "auto", "backgroundSize": "100% 100%" }'>
			<el-menu class="el-menu-horizontal-demo"
				:style='{ "border": "0", "listStyle": "none", "margin": "0 auto", "background": "linear-gradient(90deg, rgba(19,154,68,1) 0%, rgba(61,183,105,1) 36%, rgba(12,125,53,1) 100%),rgb(19,154,68)", "display": "flex", "width": "100%", "position": "relative", "justifyContent": "center" }'
			...
			<div class="body-containers"
				:style='"horizontal" == "vertical" ? { "minHeight": "100vh", "padding": "64px 0 0", "margin": "0 0 0 210px", "position": "relative", "background": "#fff", "display": "block" } : { "minHeight": "100vh", "padding": "0", "position": "relative", "backgroundImage": "url(https://gitee.com/lin-lin-lin-feng/pic/raw/master/1.jpg)" }'>
